    ...
    fn build(&self, app: &mut App) {
        app.add_system(
            camera_movement
                ...
                .label(CameraSystem::Movement),
        )
        .add_system(camera_look.run_in_state(GameState::Editor))
        .add_system(toggle_cursor.run_in_state(GameState::Editor));
    }
}
...
fn toggle_cursor(keyboard_input: Res<Input<KeyCode>>, mut windows: ResMut<Windows>) {
